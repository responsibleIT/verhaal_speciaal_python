...
Tekst bestaat uit één- en tweelettergrepige woorden. 
Woorden met -sch en -ng mogen voorkomen.  
Woorden mogen voorkomen eindigend op -nk, -b, -d(t), -ch(t), -ooi, -aai, -oei, -eeuw, -ieuw, -uw. Een-. 
Ook mogen tweelettergrepige woorden met twee of drie medeklinkers na elkaar zoals staart, botst, sprong, bankje, knappe, winkel. 
Er mogen ook enkele makkelijke drielettergrepige woorden voorkomen, zoals Sinterklaas. 
De zinnen zijn meestal kort, maar samengestelde zinnen kunnen voorkomen. 
Hoofdletters worden gebruikt.'
'''

level_three = '''Leesniveau 3: 
Er mogen woorden gebruikt worden met 3 of meer lettergrepen. 
De zinnen mogen langer zijn. 
De zinnen kunnen bestaan uit een hoofdzin met een bijzin. 
Gebruik van leenwoorden, zoals bureau, horloge, chauffeur is bij uitzondering toegestaan. 
Ook eenvoudige leenwoorden komen voor: i en y uitgesproken als ie; c uitgesproken als k of als s, gamen 
Hoofdletters worden gebruikt.'
'''
level_four = '''Leesniveau 4: 
